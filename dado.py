...
def DrawGLScene():
    ...
    # 1/6
    # Back Face
    glTexCoord2f(1, 1.0); glVertex3f(-1.0, -1.0, -1.0) #p4
    glTexCoord2f(1.0, 1.0/2.0); glVertex3f(-1.0,  1.0, -1.0) #p2
    glTexCoord2f(2.0/3.0, 1.0/2.0); glVertex3f( 1.0,  1.0, -1.0) #p1
    glTexCoord2f(2.0/3.0, 1.0); glVertex3f( 1.0, -1.0, -1.0) #p3
    ...
    glTexCoord2f(1.0, 0.0); glVertex3f(-1.0,  1.0,  1.0) #p1
    glTexCoord2f(2.0/3.0, 0.0); glVertex3f(-1.0,  1.0, -1.0)
